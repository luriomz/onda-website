  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto max-w-[1200px] px-5 md:px-8">
        ...
        >
          Análise de público em tempo real, venda de bilhetes via M-Pesa e check-in sem fricção.
    ...
    >
      ...
      <div className="grid grid-cols-3 gap-0">
        ...
        <div className="border-r border-[hsl(var(--border-subtle))] p-4 space-y-3">
          ...
          {["Visão Geral", "Eventos", "Análise", "Finanças", "Definições"].map((item) => (
            <div
              key={item}
        ...
        <div className="col-span-2 p-5 space-y-4">
          ...
          <div className="grid grid-cols-3 gap-3">
            {[
              { label: "Bilhetes Vendidos", value: "1,247" },
              { label: "Receita", value: "623,500 MZN" },
              { label: "Check-in", value: "89%" },
            ].map((stat) => (
              <div
                key={stat.label}
          ...
          <div className="rounded-[8px] border border-[hsl(var(--border-subtle))] bg-[hsl(var(--bg-surface))] p-4">
            <div className="flex items-center gap-2 mb-3">
              ...
              <span className="font-sans text-[11px] text-[hsl(var(--text-muted))]">Check-ins em Directo</span>
            </div>
            {["VIP — 2 check-in", "Geral — 15 check-in", "Early Bird — esgotado"].map((entry) => (
